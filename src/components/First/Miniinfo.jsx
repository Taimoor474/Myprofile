...
const Miniinfo = () => {
  return (
    ...
    <div className='first'>
    <img className="rounded-full  border-gray-100 shadow-sm h-20 w-20 ml-16 " src={mainimg} alt="" />
  
   
    <p className="text-txtcol font-bold text-xl  texto-blk ">Taimoor Hussain</p>
    <p className="text-txtcol2 font-bold   text-lightdark ">Front-end Developer</p>
...
<div className="flex justify-between mb-1">
  <span className="text-base font-medium text-blue-700 dark:text-white">Urdu</span>
...
<div className="flex justify-between mb-1">
  <span className="text-base font-medium text-blue-700 dark:text-white">English</span>
  <span className="text-sm font-medium text-blue-700 dark:text-white">100%</span>
</div>
<div className="w-full bg-lighter rounded-full h-2.5 dark:bg-gray-700">
  <div className="bg-yellow w-full h-2.5 rounded-full "  ></div>
...
<div className="flex justify-between mb-1">
  <span className="text-base font-medium text-blue-700 dark:text-white">Spanish</span>
  <span className="text-sm font-medium text-blue-700 dark:text-white">30%</span>
</div>
<div className="w-full bg-lighter rounded-full h-2.5 dark:bg-gray-700">
...
<div className="w-full bg-lighter rounded-full h-2.5 dark:bg-gray-700">
  <div className="bg-yellow w-40 h-2.5 rounded-full "  >
    ...
    <div className='fifith p-2'>
      <p className='text-xl font-bold text-blk '>Extra Skills</p>
      <div className=' list mt-5 space-y-4 '> 
      <div className='flex space-x-3'>
      <img src={icon} className="w- h-6" alt="" /> <label htmlFor="" className='text-lightdark text-lg font-semibold'> Tailwindcss</label>
      </div>
      <div className='flex space-x-3'>
      <img src={icon} className="w- h-6" alt="" /> <label htmlFor="" className='text-lightdark text-lg font-semibold'> Nodejs</label>
      </div>
      <div className='flex space-x-3'>
      <img src={icon} className="w- h-6" alt="" /> <label htmlFor="" className='text-lightdark text-lg font-semibold'> Mongo</label>
      </div>
      <div className='flex space-x-3'>
      <img src={icon} className="w- h-6" alt="" /> <label htmlFor="" className='text-lightdark text-lg font-semibold'> Expressjs</label>
      </div>
    ...
    <div className='sixth p-2 flex  justify-center rounded-md hover:scale-105 bg-yellow text-lg text-lightdark font-semibold'>
      <button className='flex'>DOWNLOAD CV  <img className='ml-2 mt-2'  src={icon2} alt=""/></button>
